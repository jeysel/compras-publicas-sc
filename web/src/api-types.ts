...
export interface paths {
    "/api/v1/anos-disponiveis": {
         ...
         * @description Intervalo real de ano_assinatura em fct_contratos (grão de contrato, fonte de todo o dado usado pelos filtros de ano) — usado para popular os dropdowns de ano no frontend sem hardcode de intervalo, que ficava desatualizado tanto pra trás (dados anteriores a 2016 ficavam de fora) quanto pra frente (anos futuros sem dado real apareciam como opção).
         */
        get: operations["get_anos_disponiveis_api_v1_anos_disponiveis_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        AnosDisponiveis: {
            /**
             * Ano Min
             * @description Menor ano_assinatura com contrato real
             */
            ano_min: number;
            /**
             * Ano Max
             * @description Maior ano_assinatura com contrato real
             */
            ano_max: number;
        };
...
export interface operations {
    get_anos_disponiveis_api_v1_anos_disponiveis_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["AnosDisponiveis"];
                };
            };
        };
    };
